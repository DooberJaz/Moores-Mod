...
import com.dooberjaz.mooresmod.util.recipe.CodeChickenLibWorkaround.ArrayUtils;
...
public class TileEntityMooresMachine extends TileEntity implements IInventory, ISidedInventory {

    private ItemStack result = ItemStack.EMPTY;
    private ItemStack[] matrix = new ItemStack[81];

    public TileEntityMooresMachine() {
        ArrayUtils.fillArray(matrix, result);
    }
