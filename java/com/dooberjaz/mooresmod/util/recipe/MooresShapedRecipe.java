...
public class MooresShapedRecipe extends RecipeBase {
    ...
    public MooresShapedRecipe(@Nonnull ItemStack result, ShapedPrimer primer) {
        output = result.copy();
        width = primer.width;
    ...
    public static MooresShapedRecipe fromJson(JsonContext context, JsonObject json) {
        ...
        return new MooresShapedRecipe(result, primer);
    }
}
